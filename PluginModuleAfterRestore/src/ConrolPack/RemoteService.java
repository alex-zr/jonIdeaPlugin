...
public class RemoteService {
    ...
    private Task task2_3 = new Task("sprint2", "Task3Name", "Программа вводит два числа с клавиатуры и выводит их сумму на экран.", new TaskFile("sprint2/Task3Name", "public class Task4Name{\n public static void main(String[] args){\nSystem.out.println(\" Hello6 \");}\n}"));
